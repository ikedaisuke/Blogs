...
![img/Add/start.png](/img/Add/start.png?raw=true)

この小さいウィンドウをリサイズして大きくしておきます。

![img/Add/resized.png](/img/Add/resized.png?raw=true)

#### ファイルをロード

![img/Add/prepare.png](/img/Add/prepare.png?raw=true)
...
![img/Add/go.png](/img/Add/go.png?raw=true)
...
![img/Add/proved.png](/img/Add/proved.png?raw=true)

![img/Add/result.png](/img/Add/result.png?raw=true)
